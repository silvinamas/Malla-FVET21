...
<head>
  ...
  <style>
    ...
    .bloqueada { color: gray; border-left-color: gray; background-color: #e3e3e3}
    .aprobada { text-decoration: line-through; color: black; border-left-color: green; background-color: #cbf5d4}
  </style>
</head>
<body>
  ...
  <script>
    ...
    const correlativas = {
      ...
      INM: ["AS", "BQD", "HSE", "MB"], PG: ["AT", "FIS1", "GE", "MB"]
    };
